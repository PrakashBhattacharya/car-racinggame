...
function setup(){
  ...
  box13 = new Box(700, 100, 30, 30);
  box14 = new Box(700, 100, 30, 30);
  box15 = new Box(700, 100, 30, 30);
  box16 = new Box(700, 100, 30, 30);
  box17 = new Box(700, 100, 30, 30);
  box18 = new Box(700, 100, 30, 30);
  box19 = new Box(700, 100, 30, 30);
  box20 = new Box(700, 100, 30, 30);
